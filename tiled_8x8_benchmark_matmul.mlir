//mlir-opt -affine-loop-tile="tile-sizes=8,8" benchmark_matmul.mlir > tiled_8x8_benchmark_matmul.mlir
//from benchmark_matmul.mlir
...
module {
  ...
  func.func @main() {
    ...
    %1 = call @rtclock() : () -> f64
    affine.for %arg0 = 0 to %idx5 step 8 {
