// mlir-opt -affine-loop-tile="tile-sizes=348,512,16" matmul.mlir > 1_affine_looptiles.mlir

//mlir-opt -convert-linalg-to-loops -lower-affine -convert-scf-to-cf -convert-cf-to-llvm -convert-arith-to-llvm -convert-func-to-llvm -expand-strided-metadata -finalize-memref-to-llvm -reconcile-unrealized-casts --convert-to-llvm 1_affine_looptiles.mlir | mlir-cpu-runner -O3 -e main -entry-point-result=void -shared-libs=/mnt/d/LLVM/Polygeist/llvm-project/build/lib/libmlir_c_runner_utils.so
